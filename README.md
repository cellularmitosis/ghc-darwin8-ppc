...
- [llvm-7-darwin-ppc](https://github.com/cellularmitosis/llvm-7-darwin-ppc) — clang 7.1.1 rebuilt with Apple's old PPC bits.
- [rogerppc](https://github.com/cellularmitosis/rogerppc) — Rosetta-for-PPC (run ppc binaries on arm64 via qemu).
