...
*Updated: 2026-04-24 session 12c (post-v0.7.0, PPC ghc-iserv built; TH protocol works through SSH).*
...
- 2026-04-24 session 12b/c: PPC `ghc-iserv` cross-builds and runs on
  ...
  (v0.7.0).  TH splices reach iserv successfully; final hop
  (filesystem-namespace mirror or proxy/remote split) deferred to
  session 12d.
