...
*Updated: 2026-04-24 session 12d (post-v0.7.1, TH partial: small .o's load; BR24 OOR on large .o's deferred).*
...
- 2026-04-24 session 12d: filesystem mirror works around path
  ...
  iserv on Tiger (v0.7.1).  Large `.o`s (e.g. base) hit a BR24
  jump-island out-of-range — same per-section-mmap restructuring
  issue as the v0.6.1 resolveImports bug, but in symbol_extras
  allocation.  Deferred to session 12e.
