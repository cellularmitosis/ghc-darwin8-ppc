...
#else
-- ghc-darwin8-ppc: 10.4u SDK on Tiger has neither IP_RECVTOS nor
-- IP_TOS visible to the preprocessor.  Mirrors the IPv4PktInfo
...
#else
-- ghc-darwin8-ppc: IPV6_TCLASS was added in macOS 10.7; not in the
-- 10.4u SDK.
